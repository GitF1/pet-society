...
export default function HoangScreen() {
  const router = useRouter();

  return (
    <ImageBackground 
      source={require("@/assets/images/avatar/panda4.jpg")} // Đặt ảnh vào thư mục assets/images
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={styles.content}>
          ...
          {/* Nút Next */}
          <TouchableOpacity style={styles.button} onPress={() => router.push("/hoang/welcome_2")}>
